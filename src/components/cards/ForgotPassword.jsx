    ...
    <>
      <div
        ...
        <div
          ...
          <div
            className="border border-gray-200 rounded-xl shadow-sm bg-transparent dark:border-neutral-800">
            <div className="p-4 sm:p-7">
              <div className="text-center">
                <h2 className="block text-2xl font-bold text-gray-800 dark:text-neutral-200">Forgot password?</h2>
              ...
              <div className="mt-5">
                <form>
                  <div className="grid gap-y-4">
                    ...
                    style={{backgroundColor: color}}>Reset
                      password
                    </button>
                  </div>
                </form>
